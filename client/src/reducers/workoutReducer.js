...
function workoutDeleteReducer(state = { workouts: {} }, action) {
	switch (action.type) {
		case WORKOUT_DELETE_REQUEST:
			return { loading: true };
		case WORKOUT_DELETE_SUCCESS:
			return { loading: false, workout: action.payload, success: true };
...
export { workoutSaveReducer, workoutPersonalListReducer, workoutDeleteReducer };
